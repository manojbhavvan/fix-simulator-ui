...
export default function Dashboard() {
  return (
    <main className="bg-background px-8 py-8 h-full flex flex-col h-[650px]">
      <section
        id="dashboard"
        className="
          grid
      ...
      >
        ...
        <div className="xl:col-span-7 flex">
          <div className="flex-1 border border-border rounded-lg bg-background shadow-sm h-[600px]">
            <FixSessionHealth />
          </div>
        </div>
      </section>
